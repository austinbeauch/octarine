...
'''
    Provide the LaTeX header and footer for a LaTeX AAS-journal style deluxtable that makes
    an OSSOS Data Release .detections file more human-readable.

    This is the format of table used in the OSSOS first-quarter paper.
'''
